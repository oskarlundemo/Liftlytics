...
export const LandingFooter = () => {
    ...
    return (
        <footer className={'landing-page-footer flex flex-col gap-5 h-fit p-5'}>
            ...
            <h2 style={{color: 'var(--color-text-muted)'}} className={'text-bold m-0 italic text-right'}>* These reviews are just for fun — I built them to make the marquee look cool.</h2>

            <div className={'flex flex-row-reverse items-center justify-center author-credentials gap-5'}>

                <a target='_blank' rel="noopener noreferrer" href='https://github.com/oskarlundemo/Liftlytics'>
                    <svg className={'h-10 prisma-glow'} viewBox="0 0 128 128">
                ...
                <h4 style={{color: 'var(--color-text-muted)'}} className={'m-5 text-xl font-bold text-center'}>Lundemo @ 2025</h4>
            </div>
