...
import {TechIcon} from "../MiscComponents/TechIcon.tsx";
...
export const FAQ = ({}) => {
    ...
    return (
        <section className={'faq-container my-10 flex flex-col w-full gap-5'}>
            ...
            <h2 className={'behind-title'}>Behind the project</h2>
            ...
            <DropDownMenu>
                ...
                <DropDownCard
                    ...
                    singleElement={
                        <div className={'p-5 text-faq-wrapper flex flex-col gap-5'}>
                            <p>
                                I’ve always been interested in fitness, and at the same time I wanted to sharpen my skills in data visualization. This project felt like the perfect opportunity to bring those two passions together. It wasn’t just about coding charts and graphs — it was about exploring how to turn raw information into something meaningful and useful in everyday life.
                            </p>

                            <p>
                                By working on this, I’ve been able to practice building clear, interactive visuals while also creating something that I personally benefit from. For me, that’s the best kind of project: one that’s both a learning experience and a tool I’ll actually use.
                            </p>
                        </div>
                    }
                    arrow={true}
                ...
                <DropDownCard
                    ...
                    singleElement={
                        <div className="p-5 text-faq-wrapper justify-center grid grid-cols-3 grid-rows-3 gap-5">

                            <TechIcon
                                svg={
                                    <svg className={'typescript-glow'} viewBox="0 0 128 128">
                            ...
                            <TechIcon
                                svg={
                                    <svg className={'react-glow'} viewBox="0 0 128 128">
                            ...
                            <TechIcon
                                svg={
                                    <svg className={'supabase-glow'} viewBox="0 0 128 128">
                            ...
                            <TechIcon
                                svg={
                                    <svg className={'prisma-glow'} fill={'#a0aec0'} viewBox="0 0 128 128">
                            ...
                            <TechIcon
                                svg={
                                    <svg className={'react-glow'} fill={'cyan'} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"><path d="M640-160v-280h160v280H640Zm-240 0v-640h160v640H400Zm-240 0v-440h160v440H160Z"/></svg>
                                }
                                name={'Recharts'}
                            />
                ...
                <DropDownCard
                    title={'What lessons do you take from this project?'}
                    singleElement={
                    <div className={'text-faq-wrapper p-5'}>

                        <p>
                            Besides getting more familiar with UI libraries like <u>Framer Motion</u> and <u>dnd-kit</u>, my biggest game-changer has been <u>Axios</u> paired with <u>React Query</u>. In my previous React projects, I would fetch data on mount using the <u>useEffect</u> hook—but now, after switching to React Query, I can’t imagine going back.
                        </p>

                        <p>
                            <u> React Query</u> and <u>Axios</u> make data fetching <u>so much cleaner, more manageable, and scalable</u>. No more manually tracking loading and error states, no more boilerplate—everything just “clicks” into place.
                            Also, I got more familiar with <u>TypeScript</u> and <u>Tailwind</u> on every line of code, since this was my first real TypeScript project.
                ...
                <DropDownCard
                    ...
                    singleElement={
                        <div className={'p-5'}>
                            <p>Sure, shoot me an e-mail (<a href="mailto:oskarlundemo@.com" style={{color: 'var(--color-accent)'}} className="underline">oskar@lundemo.com</a>) and let's talk ;-)</p>
                        </div>
                    }
                    arrow={true}
                />
